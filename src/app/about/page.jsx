...
import createPost from "@/src/helper/functions/createNewPost";

const AboutComp = ({ searchParams }) => {
  console.log("hello this is searchParams : ", searchParams);
  // useEffect(() => {
  //   createPost(searchParams);
  // }, []);
  return (
